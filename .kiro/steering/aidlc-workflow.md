...
# AI-DLC Workflow Active — homework-tracker
...
- **Manifest**: `.aidlc/workflow/homework-tracker/aidlc-manifest.yaml`
- **Specs**: `.kiro/specs/homework-tracker/`
- **Workflow**: `.aidlc/workflow/homework-tracker/`
...
1. Read `.aidlc/workflow/homework-tracker/aidlc-manifest.yaml` for current state
